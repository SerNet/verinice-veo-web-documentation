...
![Risk definition](  ../assets/manual/risk_confidentiality.de.png)
...
![Risk categories and probability of occurrence](  ../assets/manual/risk_category_probability.de.png)
...
![Risk definition](  ../assets/manual/risk_impact_gs.de.png)
You can currently adapt the names and descriptions for all parameters to your organization.
![Risk definition](  ../assets/manual/risk_values.de.gif)
