...
![Risk definition](  ../assets/manual/risk_confidentiality.png)
...
![Risk categories and probability of occurrence](  ../assets/manual/risk_category_probability.png)
...
![Risk definition](  ../assets/manual/risk_impact_gs.png)
You can currently adapt the names and descriptions for all parameters to your organization.
![Risk definition](  ../assets/manual/risk_values.gif)
