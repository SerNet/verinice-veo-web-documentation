...
`GET /domains/DOMAIN-ID /en/assets?name=fire` ([OpenAPI documentation](https://api.verinice.com/veo/swagger-ui/index.html?configUrl=/veo/v3/api-docs/swagger-config#/asset-in-domain-controller/getAssets))
...
`GET /domains/DOMAIN-ID /en/assets?hasParentElements=true` ([OpenAPI documentation](https://api.verinice.com/veo/swagger-ui/index.html?configUrl=/veo/v3/api-docs/swagger-config#/asset-in-domain-controller/getAssets))
...
`GET /domains/DOMAIN-ID /en/assets?childElementIds=823dfbfa-21d4-4174-b184-38734465cbbb` ([OpenAPI documentation](https://api.verinice.com/veo/swagger-ui/index.html?configUrl=/veo/v3/api-docs/swagger-config#/asset-in-domain-controller/getAssets))
        ...
        "process_dataType": [
            {
                ...
                "target": {
                    ...
                    "targetUri": "https://api.verinice.com/veo /en/assets/faf5d744-2bc8-4c19-bd5f-783f59d719a2",
                    "searchesUri": "https://api.verinice.com/veo /en/assets/searches",
                    "resourcesUri": "https://api.verinice.com/veo /en/assets{?unit,displayName,subType,status,\
...
`POST /domains/DOMAIN-ID /en/assets` ([OpenAPI documentation](https://api.verinice.com/veo/swagger-ui/index.html?configUrl=/veo/v3/api-docs/swagger-config#/asset-in-domain-controller/createElement_7))
...
url = "https://api.verinice.com/veo/domains/b5110307-ca95-4bcb-bd7a-d2570f3d8946 /en/assets"
token = get_token()
headers = {
    "Authorization": token,
