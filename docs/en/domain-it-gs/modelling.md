...
![Apply modules from catalog]( ../assets/domain-it-gs/verinice-32-apply-modules.de.png)
...
![Model modules]( ../assets/domain-it-gs/verinice-32-modell-modules-1.de.png)
...
![Select modules]( ../assets/domain-it-gs/verinice-32-select-modules.de.png)

- Once you save the dialog, the modeled modules will appear under **Modules** in the target object.

![Modeled modules]( ../assets/domain-it-gs/verinice-32-modelled-modules.de.png)
...
![Assign target objects]( ../assets/domain-it-gs/verinice-37-assign-target-object.de.png)
...
![Select target objects]( ../assets/domain-it-gs/verinice-37-select-target-objects.de.png)

- After saving, the module will list the target objects it is modeled for under **Target Objects**.

![Modeled target objects]( ../assets/domain-it-gs/verinice-37-modelled-target-objects.de.png)
...
![Edit modules]( ../assets/domain-it-gs/verinice-32-edit-modules.de.png)
...
![Custom module]( ../assets/domain-it-gs/verinice-32-user-defined-module.de.png)
