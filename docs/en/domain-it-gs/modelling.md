...
![Apply modules from catalog]( ../assets/domain-it-gs/verinice-32-apply-modules.png)
...
![Model modules]( ../assets/domain-it-gs/verinice-32-modell-modules-1.png)
...
![Select modules]( ../assets/domain-it-gs/verinice-32-select-modules.png)

- Once you save the dialog, the modeled modules will appear under **Modules** in the target object.

![Modeled modules]( ../assets/domain-it-gs/verinice-32-modelled-modules.png)
...
![Assign target objects]( ../assets/domain-it-gs/verinice-37-assign-target-object.png)
...
![Select target objects]( ../assets/domain-it-gs/verinice-37-select-target-objects.png)

- After saving, the module will list the target objects it is modeled for under **Target Objects**.

![Modeled target objects]( ../assets/domain-it-gs/verinice-37-modelled-target-objects.png)
...
![Edit modules]( ../assets/domain-it-gs/verinice-32-edit-modules.png)
...
![Custom module]( ../assets/domain-it-gs/verinice-32-user-defined-module.png)
