...
![Profil(e) auswählen](../assets/manual/unit_profile.png)
...
![Domäne(n) auswählen](../assets/manual/unit_domain.png)

4. Wenn die gewählten Angaben korrekt sind, bestätigen Sie die Erstellung Ihrer ersten Unit:

![Zusammenfassung](../assets/manual/unit_summary.png)
...
![Weitere Schritte](../assets/manual/welcome_more.png)
