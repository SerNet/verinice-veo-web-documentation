...
![Bausteine aus Katalog anwenden](../assets/domain-it-gs/verinice-32-apply-modules.png)
...
![Bausteine modellieren](../assets/domain-it-gs/verinice-32-modell-modules-1.png)
...
![Auswahl der Bausteine](../assets/domain-it-gs/verinice-32-select-modules.png)

- Nachdem Sie den Dialog gespeichert haben, werden Ihnen im Zielobjekt unter **Bausteine** die modellierten Bausteine angezeigt.

![Modellierte Bausteine](../assets/domain-it-gs/verinice-32-modelled-modules.png)
...
![Zielobjekte zuordnen](../assets/domain-it-gs/verinice-37-assign-target-object.png)
...
![Auswahl der Zielobjekte](../assets/domain-it-gs/verinice-37-select-target-objects.png)
...
![Modellierte Zielobjekte](../assets/domain-it-gs/verinice-37-modelled-target-objects.png)
...
![Bausteine bearbeiten](../assets/domain-it-gs/verinice-32-edit-modules.png)
...
![Benutzerdefinierter Baustein](../assets/domain-it-gs/verinice-32-user-defined-module.png)
